...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Verkehrsplaner – 2D Verkehrssimulation" },
      {
        name: "description",
        content:
          "Straßenbau und Verkehrsfluss als Simulation: Spuren, Ampelphasen, Kreisverkehre und emergente Staus.",
      },
      { property: "og:title", content: "Verkehrsplaner – 2D Verkehrssimulation" },
      {
        property: "og:description",
        content: "Straßenbau und Verkehrsfluss als Top-Down-Simulation im Browser.",
      },
